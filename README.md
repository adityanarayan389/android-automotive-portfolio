...
Open `index.html` in a browser, or host the folder on GitHub Pages, Netlify, or Vercel.

## What to customize first

1. Replace the contact links in `index.html`
2. Swap the placeholder case studies with your real projects
3. Add exact outcomes for each project where possible
4. Add your LinkedIn and GitHub
